...
const FeaturedTrips = ({ flip }) => {
  return (
    <div className="featuredtrips" style={flip && { flexDirection: 'row-reverse', backgroundColor: '#E6F1F4', padding: '20px' }}>
      <div className="left">
        <img src={muktinath} alt="Muktinath" />
      </div>
      <div className="right" style={flip && { marginLeft: '0px', marginRight: '100px' }}>
