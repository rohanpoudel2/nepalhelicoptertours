...
const Why = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Why Nepal Helicopter Tours</title>
        <meta name='description' content={"We offer variety of Helicopter Tour Packages at an Affordable Price for all interested in different proposes."} />
